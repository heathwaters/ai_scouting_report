...
| Tier | Price | Annual Price | Annual Savings |
|------|-------|--------------|----------------|
| FREE | $0/month | N/A | N/A |
| PRO TIER | $12.99/month | $139/year | 11% |
| ELITE TIER | $29.99/month | $299/year | 17% |

### Features by Tier

**FREE TIER**
- NO AI Features (Locked)
- Basic Profile
- Rankings
- Match History
- Tournaments
...
- 1 FREE Scout Report per Week
- Scouting Reports (4 per month with credits)
- Win Predictor (20 uses per month)
- Tournament Difficulty Rating (25 uses per month)
- Weekly Summary
- In-App Purchase option: $0.99 for extra scouts

**ELITE TIER**
- 500 CREDITS per month
- 20 FREE Scout Reports per month
- All Pro Features
- Opponent Tendency Analysis
- College Recruiting Reports
- Training Focus Recommendations
- AI Chat (500 questions per month)
- 25% Credit Rollover
...
**STAGE 1: VISITORS**
- 10,000 Visitors (Marketing, SEO, Referrals)
- 50% Sign-Up Rate
...
- Landing Page Optimization Focus:
  ...
  - Social proof
  - Demo videos
- Features: Profile setup, Rankings tracking, Browse features

**STAGE 3: CONVERSION**

From Free Users:
- 10% Convert to Pro (500 Pro Users)
- 85% Stay Free (4,250 Free Active)
- 5% Churn (Lost Users)

**STAGE 4: PRO USERS**
- 500 Pro Users Total
- Features: AI features, 100 credits, Weekly bonus

Pro User Outcomes:
- 18% Upgrade to Elite (90 Elite Users)
- 75% Stay Pro (375 Pro Active)
- 7% Churn (35 users)

**STAGE 5: ELITE USERS**
- 90 Elite Users
- Features: 500 credits, Priority support, Advanced features
- 3% Churn (3 users)
...
|--------|--------|------------------|
| Free to Pro | 10% | 2-5% (Goal: 8-12%) |
| Pro to Elite | 18% | Premium upsell |
| Pro Churn | <8% monthly | N/A |
| Elite Churn | <5% monthly | N/A |

### Key Conversion Levers

1. Onboarding quality (Free to Pro)
2. Weekly free report (Pro retention)
3. Credit scarcity (Pro to Elite)
